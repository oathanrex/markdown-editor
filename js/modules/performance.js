...
export class Performance {
    constructor(options = {}) {
        ...
        this.workerThreshold = options.workerThreshold || 50000;
    }
    ...
    debounce(func, wait, immediate = false) {
        ...
        return function executedFunction(...args) {
            ...
            timeout = setTimeout(later, wait || this.debounceInterval);
    ...
    throttle(func, limit) {
        ...
        return function executedFunction(...args) {
            ...
            if (!inThrottle) {
                ...
                inThrottle = true;
                setTimeout(() => inThrottle = false, limit || this.throttleInterval);
            }
        };
    }
    ...
    shouldUseWorker(contentLength) {
        // Use worker for content > workerThreshold
        return contentLength > (this.workerThreshold || 50000) && typeof Worker !== 'undefined';
    }
